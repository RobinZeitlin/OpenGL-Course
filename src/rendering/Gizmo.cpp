...
Gizmo::Gizmo(const float* someVertices, size_t aVertexSize, unsigned int* someIndices, size_t aIndexSize)
...
void Gizmo::Draw(Shader* aShader)
{
    if (myTexture != NULL) {
...
void Gizmo::apply_texture(Texture* aTexture) {
    myTexture = aTexture;
}
